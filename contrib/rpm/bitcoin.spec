...
%if %{_buildqt}
# qt icons
install -D -p share/pixmaps/r3vcoin.ico %{buildroot}%{_datadir}/pixmaps/r3vcoin.ico
install -p share/pixmaps/nsis-header.bmp %{buildroot}%{_datadir}/pixmaps/
install -p share/pixmaps/nsis-wizard.bmp %{buildroot}%{_datadir}/pixmaps/
install -p %{SOURCE100} %{buildroot}%{_datadir}/pixmaps/bitcoin.svg
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/r3vcoin16.png -w16 -h16
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/r3vcoin32.png -w32 -h32
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/r3vcoin64.png -w64 -h64
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/r3vcoin128.png -w128 -h128
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/r3vcoin256.png -w256 -h256
%{_bindir}/convert -resize 16x16 %{buildroot}%{_datadir}/pixmaps/r3vcoin256.png %{buildroot}%{_datadir}/pixmaps/r3vcoin16.xpm
%{_bindir}/convert -resize 32x32 %{buildroot}%{_datadir}/pixmaps/r3vcoin256.png %{buildroot}%{_datadir}/pixmaps/r3vcoin32.xpm
%{_bindir}/convert -resize 64x64 %{buildroot}%{_datadir}/pixmaps/r3vcoin256.png %{buildroot}%{_datadir}/pixmaps/r3vcoin64.xpm
%{_bindir}/convert -resize 128x128 %{buildroot}%{_datadir}/pixmaps/r3vcoin256.png %{buildroot}%{_datadir}/pixmaps/r3vcoin128.xpm
%{_bindir}/convert %{buildroot}%{_datadir}/pixmaps/r3vcoin256.png %{buildroot}%{_datadir}/pixmaps/r3vcoin256.xpm
...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 13844
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 13843
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 15844
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 15843
...
if [ $1 -eq 0 ]; then
	if [ `%{_sbindir}/sestatus |grep -c "disabled"` -eq 0 ]; then
	%{_sbindir}/semanage port -d -p tcp 13844
	%{_sbindir}/semanage port -d -p tcp 13843
	%{_sbindir}/semanage port -d -p tcp 15844
	%{_sbindir}/semanage port -d -p tcp 15843
	for selinuxvariant in %{selinux_variants}; do
