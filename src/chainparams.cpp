...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x00000000000000000000000000000000000000000000000000032f30178c8039");

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x8c08a83f2880a0ac9e9a777d8f0d90dc49d31adc3de7ebb4c89f7bca5993c6f2"); //20830
        ...
        checkpointData = (CCheckpointData) {
            ...
            (16384, uint256S("0xc88ac8496d6c11c691f5cb0c65ee5cf6bbf341bfba1c5a5e4715c4a8f082592b"))
        };
...
public:
    CTestNetParams() {
        ...
        //vSeeds.push_back(CDNSSeedData("r3v.co", "testnet-seed.r3v.co"));
