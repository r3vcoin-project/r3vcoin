...
const char * const BITCOIN_CONF_FILENAME = "r3vcoin.conf";
const char * const BITCOIN_PID_FILENAME = "r3vcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "R3VCoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/R3VCoin";
#else
    // Unix
    return pathRet / ".r3vcoin";
#endif
#endif
}
