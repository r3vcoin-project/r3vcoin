...
static const int64_t DEFAULT_MAX_TIP_AGE = 28800; //8 * 60 * 60 (8 hours)
...
bool CheckBlock(const CBlock& block, CValidationState& state, const Consensus::Params& consensusParams, bool fCheckPOW = true, bool fCheckMerkleRoot = true, bool fCheckSig = true, bool fCheckFlood = true);
