...
*Setup instructions for a Gitian build of R3VCoin Core using a Debian VM or physical system.*
...
- [Building R3VCoin Core](#building-r3vcoin-core)
...
Building R3VCoin Core
----------------

To build R3VCoin Core (for Linux, OS X and Windows) just follow the steps under 'perform
