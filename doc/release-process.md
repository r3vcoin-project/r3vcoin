...
space *do not upload these to the r3v.co server, nor put them in the torrent*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the r3v.co server.

```

- Update r3v.co version
